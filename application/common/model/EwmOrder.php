...
class EwmOrder extends BaseModel
{
     ...
     * @return int|string
     */
    function addGemaPayOrder($userid, $money, $orderNum, $codeId, $payMoney, $qrCode, $gemaUsername, $type, $tradeNo, $merchantOrderNo, $admin_id, $notify_url, $member_id,$pay_username='',$uid=0)
    {
        $data = [
            'add_time' => time(),
