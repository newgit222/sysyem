...
use think\Db;
use think\Log;
class NiuNiuDfPay extends DaifuPayment
{
    public function pay($params,$dfChannel){
        ...
        Log::error('NiuNiuDfPay Api Data :'.json_encode($data,true));
        ...
        Log::error('NiuNiuDfPay Return Data :'.$result);
...
//        $string_a = substr($string_a,0,strlen($string_a) - 1);
        //签名步骤三：MD5加密
        Log::error('NiuNiuDfPay str :'.$string_a . 'key=' . $secret);
...
//        $result = strtoupper($sign);
    ...
    public function notify(){
        ...
        Log::notice("Daifu NiuNiuDfPay Notify post json Data".$input);
        $notifyData = $_POST;
        Log::notice('DaifuNiuNiuDfPayNotifyPostFormData:' . json_encode($notifyData,true));
