...
layui.define(["form", "upload"], function(t) {
    ...
    }),n.on("submit(set_sys_config)", function(t) {
        //这里是基本信息
        i.post("sys_config",t.field,function (res) {
            return e.msg(res.msg, {icon: res.code == 1 ? 1: 2,time: 1500},function () {
                // window.location.reload()
            })
        });
    ...
    }),n.on("submit(setCommand)",function (t) {
        //设置口令
        i.post("setCommand",t.field,function (res) {
            return e.msg(res.msg, {icon: res.code == 1 ? 1: 2,time: 1500},function () {
                window.location.reload()
            })
        });
    }),n.on("submit(security_code)",function (t) {
        //设置口令
        i.post("security_code",t.field,function (res) {
            return e.msg(res.msg, {icon: res.code == 1 ? 1: 2,time: 1500},function () {
                parent.window.location.reload()
            })
        });
