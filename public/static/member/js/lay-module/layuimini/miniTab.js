...
layui.define(["element", "layer", "jquery"], function (exports) {
    ...
    var miniTab = {
        ...
        create: function (options) {
            ...
            $.getJSON('/member/index/isSetSecurityPwd', function (data) {
                isSet = data.code;
            })
            $.getJSON('/member/index/isSetPwd', function (data) {
                isPwd = data.code;
            })
            ...
            if (isSet){
                if (isPwd){
                    ...
                    ele.tabAdd('layuiminiTab', {
                        title: '修改密码'
                        , content: '<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"   src="/member/servers/editPass"></iframe>'
                        , id: options.tabId
                    });
                }
                ...
                if (isPwd){
                    ele.tabAdd('layuiminiTab', {
                        title: '设置安全码'
                        , content: '<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"   src="/member/user/editsafety"></iframe>'
                        , id: options.tabId
                    });
                }else{
                    ele.tabAdd('layuiminiTab', {
